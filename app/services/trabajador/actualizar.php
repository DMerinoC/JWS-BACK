...
if (isset($_POST["CodigoTrabajador"], $_POST["CodigoRol"], $_POST["NombreTrabajador"], $_POST["CorreoTrabajador"], $_POST["UsuarioTrabajador"], $_POST["ClaveTrabajador"], $_POST["SueldoTrabajador"], $_POST["SueldoExtraTrabajador"])) {
    ...
    if (!empty($CodigoTrabajador) && !empty($CodigoRol) && !empty($NombreTrabajador) && !empty($CorreoTrabajador) && !empty($UsuarioTrabajador) && !empty($ClaveTrabajador) && !empty($SueldoTrabajador) && !empty($SueldoExtraTrabajador)) {
        $hashedPassword = password_hash($ClaveTrabajador, PASSWORD_BCRYPT);
        // INSTANCIAMOS
        $trabajador = new trabajador($CodigoTrabajador, $CodigoRol, $NombreTrabajador, $CorreoTrabajador, $UsuarioTrabajador, $hashedPassword, $SueldoTrabajador, $SueldoExtraTrabajador, "");
        // APLICAMOS GUARDAR
