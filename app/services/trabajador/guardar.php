...
if (isset($_POST["CodigoRol"], $_POST["NombreTrabajador"], $_POST["CorreoTrabajador"], $_POST["UsuarioTrabajador"], $_POST["ClaveTrabajador"], $_POST["SueldoTrabajador"])) {
    ...
    if (!empty($CodigoRol) && !empty($NombreTrabajador) && !empty($CorreoTrabajador) && !empty($UsuarioTrabajador) && !empty($ClaveTrabajador) && !empty($SueldoTrabajador)) {
        $hashedPassword = password_hash($ClaveTrabajador, PASSWORD_BCRYPT);
        $trabajador = new trabajador("", $CodigoRol, $NombreTrabajador, $CorreoTrabajador, $UsuarioTrabajador, $hashedPassword, $SueldoTrabajador, "");
